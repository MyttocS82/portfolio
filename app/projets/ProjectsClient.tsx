    ...
    return (
        <>
            ...
            ${
              ...
              ${
                            activeTag === tag
                                ? 'bg-blue-600 text-white border-blue-600 dark:text-slate-300'
                                : 'bg-white text-slate-700 hover:bg-slate-100 dark:bg-slate-700 dark:text-slate-200 dark:border-slate-700 dark:hover:bg-slate-600'
                        }`}
                    >
                        {tag}
                    </button>
